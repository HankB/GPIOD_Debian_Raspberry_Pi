...
int main(int argc, char **argv)
{
    ...
    printf("===== line configured for write, default high\n");
    report_line_attributes(gpio_8, "SPI_CE0_N");
    printf("============\n\n");

    sleep(2); // GPIO 8 should be driven high here.

    rc = gpiod_line_set_value(gpio_8, 0);
    if (rc < 0)
    {
    ...
    sleep(2); // GPIO 8 should be driven low here.
